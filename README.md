...
## 2026-03-09 Phase 3B — Automation + Notifications + Payroll Forecast

Included in this repo package:
- notification center groundwork at `/admin/notifications`
- shared operations alert model in `src/lib/opsNotifications.ts`
- dashboard action center upgraded with reminder-ready, blocker, budget-risk, and export-readiness signals
- analytics upgraded with forecast movement and shared management signals
- projects upgraded with forecast-burn visibility and direct notification-center handoff
- approvals upgraded with reminder-readiness and faster access to the new notification surface

See:
- `docs/PHASE_3B_RELEASE_2026-03-09.md`
- `docs/PHASE_3B_QA_CHECKLIST_2026-03-09.md`
