      ...
      <div style={{ maxWidth: 1100, marginTop: 12 }}>
        ...
        <div className="setuSignalGrid" style={{ marginBottom: 14 }}>
          <div className="setuSignalCard">
            ...
            <span>{financeSummary.totals.overBudgetProjects} over budget and {financeSummary.totals.nearBudgetProjects} nearing budget limits.</span>
          </div>
          <div className="setuSignalCard">
          ...
          <div className="setuSignalCard">
            <div className="setuSignalLabel">Forecast burn</div>
            <strong>{formatMoney(financeSummary.totals.forecastAmount)}</strong>
            <span>Actual plus pending approvals, useful before closing payroll or sending budget alerts.</span>
          </div>
        </div>
